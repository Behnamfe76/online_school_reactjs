								...
								<div className='col-lg-8 mx-auto text-center mt-4'>
									<form className='bg-body shadow rounded p-2'>
										<div className='input-group'>
											...
											<button
												type='button'
												className='btn btn-blue mb-0 rounded'>
												Submit
											</button>
										</div>
									</form>
								...
								<div className='row g-4 text-center'>
									...
									<div className='col-sm-6 col-md-3'>
										<div className='card card-body card-border-hover p-0'>
											<a href='#' className='p-3'>
												<h2>
													<i className='fas fa-street-view transition-base'></i>
												</h2>
									...
									<div className='col-sm-6 col-md-3'>
										<div className='card card-body card-border-hover p-0'>
											<a href='#' className='p-3'>
												<h2>
													<i className='fas fa-hands-helping transition-base'></i>
												</h2>
									...
									<div className='col-sm-6 col-md-3'>
										<div className='card card-body card-border-hover p-0'>
											<a href='#' className='p-3'>
												<h2>
													<i className='fas fa-exclamation-circle transition-base'></i>
												</h2>
									...
									<div className='col-sm-6 col-md-3'>
										<div className='card card-body card-border-hover p-0'>
											<a href='#' className='p-3'>
												<h2>
													<i className='fas fa-flag transition-base'></i>
												</h2>
								...
								<div
									...
									<div className='accordion-item mb-3'>
										<h6 className='accordion-header font-base' id='heading-1'>
											<button
												className='accordion-button fw-bold rounded d-inline-block collapsed'
												type='button'
