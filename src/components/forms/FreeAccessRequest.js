									...
									<div className='col-12'>
										...
										<div className='bg-body shadow rounded-3 p-2'>
											<div className='input-group'>
												...
												<button
													type='button'
													className='btn btn-blue mb-0 rounded-3'>
													Request access!
												</button>
											</div>
										</div>
								...
								<div className='row g-4'>
									...
									<div className='tiny-slider arrow-round arrow-dark arrow-hover'>
										<div
											...
											<div className='col-6'>
												<p className='fs-5'>
													"Make my life easier and organized conviction For
													every delay in they Extremity now strangers contained
													breakfast"
												</p>
												{/* Avatar */}
												<div className='d-flex align-items-center'>
											...
											<div className='col-6'>
												<p className='fs-5'>
													"Creating product become fun conviction For every
									...
									<div className='row'>
										<div className='col-md-8 mx-auto text-center py-4 position-relative'>
											...
											<p className='text-white'>
												...
												every delay death ask to style Me mean able
											</p>
											{/* Form */}
...
export default memo(FreeAccessRequest);
