					...
					<div className='container'>
						<div className='row g-4 g-md-5 justify-content-between'>
							...
							<div className='col-lg-6 mb-5 mb-lg-0'>
								...
								<p className='mb-5'>
									Let's find out the demo. The 1-hour demo will provide
									Happiness prosperous impression had conviction For every delay
									in their Extremity now, strangers
								</p>
							...
							<div className='col-lg-6 mb-5'>
								<div className='bg-dark rounded-3 p-4 p-sm-5 position-relative'>
									...
									<figure className='position-absolute top-0 start-50 translate-middle w-100 mt-n1'>
										<svg
											enable-background='new 0 0 420.7 53.6'
											version='1.1'
									...
									<figure className='w-100 position-absolute top-100 start-50 translate-middle'>
										<svg
											enable-background='new 0 0 607.7 74.6'
											version='1.1'
									...
									<div className='position-absolute bottom-0 end-0 mb-n5 w-100'>
										<svg
											enable-background='new 0 0 223 134'
											xml:space='preserve'
											xmlns='http://www.w3.org/2000/svg'>
											<path
