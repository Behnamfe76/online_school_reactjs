					...
					<div className='container position-relative z-index-9'>
						<div className='row g-4 g-sm-5 justify-content-between'>
							...
							<div className='col-lg-6 col-xl-5'>
								{/* Title */}
								<h3>
									Get awesome experience in an online className with our
									superior instructor
								</h3>
										...
										<div className='d-flex align-items-center'>
											...
											<div>
												<div className='icon-xl bg-body shadow rounded-circle'>
													<img
														src='assets/images/element/child.svg'
														className='h-40px'
														alt=''
													/>
												</div>
									...
									<div className='col-12 mb-5'>
										<div className='d-flex align-items-center'>
											...
											<div className='ms-3'>
												...
												<p className='text-truncate-2 mb-0'>
													Children rejoiced yet uncommonly his ten who. Yet
													uncommonly his ten who diminution astonished.
												</p>
											</div>
										</div>
							...
							<div className='col-lg-6 position-relative'>
								...
								<div className='bg-primary bg-opacity-10 rounded-3 p-4 p-sm-5'>
									{/* Title */}
									<h2 className='mb-3'>Book online className</h2>
									...
									<form className='row g-4 g-sm-3 mt-2 mb-0'>
										...
										{/* Category */}
										<div className='col-12'>
											<label className='form-label'>Select className *</label>
											<select
...
export default memo(BookclassName);
