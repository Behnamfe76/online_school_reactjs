					...
					<div className='container'>
						...
						<div className='row flex-row-reverse align-items-center g-5'>
							...
							<div className='col-lg-5 col-xl-6 position-relative z-index-1 text-center text-lg-start mb-5 mb-sm-0'>
								...
								{/* Title */}
								<h1 className='mb-0 display-6 text-end'>
									یادگیری نامحدود در نوک
								...
								{/* Content */}
								<p className='my-4 lead text-end'>
								...
								{/* Info */}
								<ul className='list-inline d-flex position-relative justify-content-center justify-content-lg-start mb-4'>
									<li className='list-inline-item me-2'>
										{" "}
										<i className='bi bi-patch-check-fill ms-1 h6 me-1'></i>
										یادگیری با متخصصان
									</li>
									<li className='list-inline-item me-2'>
										{" "}
										<i className='bi bi-patch-check-fill h6 ms-1 me-1'></i>
										دریافت گواهینامه
									</li>
									<li className='list-inline-item'>
										{" "}
										<i className='bi bi-patch-check-fill h6 ms-1 me-1'></i>در
										یافت عضویت
									</li>
								</ul>
							</div>
						...
						<div className='row g-4'>
							...
							<div className='col-sm-6 col-xl-3'>
								<div className='d-flex justify-content-center align-items-center p-4 bg-warning bg-opacity-15 rounded-3'>
									...
									<div className='me-4 h6 fw-normal mb-0'>
										<div className='d-flex'>
											...
											<span className='mb-0 h5'>هزار</span>
										</div>
										<p className='mb-0'>دوره های آنلاین</p>
									</div>
								</div>
							</div>
							{/* Counter item */}
							<div className='col-sm-6 col-xl-3'>
								<div className='d-flex justify-content-center align-items-center p-4 bg-blue bg-opacity-10 rounded-3'>
									...
									<div className='me-4 h6 fw-normal mb-0'>
										...
										<p className='mb-0'>اساتید مجرب</p>
									</div>
								</div>
							</div>
							{/* Counter item */}
							<div className='col-sm-6 col-xl-3'>
								<div className='d-flex justify-content-center align-items-center p-4 bg-purple bg-opacity-10 rounded-3'>
									...
									<div className='me-4 h6 fw-normal mb-0'>
										...
										<p className='mb-0'>دانشجویان آنلاین</p>
									</div>
								</div>
							</div>
							{/* Counter item */}
							<div className='col-sm-6 col-xl-3'>
								<div className='d-flex justify-content-center align-items-center p-4 bg-info bg-opacity-10 rounded-3'>
									...
									<div className='me-4 h6 fw-normal mb-0'>
										...
										<p className='mb-0'>دوره های همراه با گواهینامه</p>
									</div>
								</div>
							</div>
						</div>
					...
					<div className='container'>
						...
						<div className='row mb-4'>
							<div className='col-lg-8 mx-auto text-center'>
								<h2 className='fs-1'>دوره های محبوب</h2>
								<p className='mb-0'>
									دوره مورد نظر خود را از میان صد ها دوره انتخاب کنید
								</p>
							</div>
						</div>
									...
									<div className='col-sm-6 col-lg-4 col-xl-3'>
										<div className='card shadow h-100'>
											...
											<div className='card-body pb-0'>
												...
												{/* Title */}
												<h5 className='card-title fw-normal'>
													<a href='#'>Digital Marketing MasterclassName</a>
												</h5>
												<p className='text-truncate-2 mb-2'>
										...
										<div className='col-11 mx-auto position-relative'>
											<div className='row align-items-center'>
												...
												<div className='col-lg-7'>
													<h3 className='text-white'>مدرس شوید</h3>
													<p className='text-white mb-3 mb-lg-0'>
														به سرعت می گویند دارای دفع مناسب اضافه پسر. در چهارم
														مایل های کودک شک ورزش شادی بچه ها مرد خوشحال شد. با
														این حال به طور غیرمعمول ده او که کاهش می دهد حیرت
														زده
													</p>
												</div>
												{/* Content and input */}
...
Trending courses START */}
				<section className='pb-5 pt-0 pt-lg-5'>
					<div className='container'>
						...
						<div className='row mb-4'>
							<div className='col-lg-8 mx-auto text-center'>
								<h2 className='fs-1'>دوره های پر بازدید ما</h2>
								<p className='mb-0'>از دوره های پر بازدید ما دیدن کنید</p>
							</div>
						</div>
						<div className='row'>
							{/* Slider START */}
...
export default memo(DefaultLanding);
